...
<ul>
  <li>How can we measure spatial accessibility more accurately across space and time?</li>
  <li>How do urban resources, such as elderly care services, healthcare facilities, grocery stores, and green spaces, match population demand?</li>
  <li>How can causal inference be adapted to spatial and spatiotemporal data?</li>
  <li>How do dynamic human mobility patterns shape environmental exposure and health-related risks?</li>
</ul>
